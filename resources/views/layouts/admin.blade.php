            ...
            <aside class="col sidebar" style="background: #36B9CC;">
                <div class="sidebar-sticky">
                    ...
                    <ul class="nav flex-column" role="navigation">
                        ...
                        <li class="nav-item">
                            <a href="/admin/blogs" class="nav-link" title="songs" data-pjax>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.users') }}" class="nav-link" title="songs" data-pjax>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle d-flex align-items-center"
                                ...
                                <div class="avatar css-avatar"><span>{{ auth()->guard('admin')->user()->name[0] }}
                                    </span></div>

                                <span class="d-none d-lg-block ml-1">{{ auth()->guard('admin')->user()->name }}</span>
                            </a>
